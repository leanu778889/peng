...
<title>剧组信息列表页</title>
<link href="http://localhost/phpwind/res/css/admin_style.css?v20130702" rel="stylesheet" />
<script>
//全局变量，是Global Variables不是Gay Video喔

</script>
<script src="http://localhost/phpwind/res/js/dev/wind.js?v20130702"></script>
<script src="http://localhost/phpwind/res/js/dev/jquery.js?v20130702"></script>
	...
	<div class="table_list">
		<table width="100%" id="J_table_list" style="table-layout:fixed;">
			...
			<tr id="J_forum_tr_1">
				...
				<td><?php echo $value['j_name']?></td>
				<td><?php echo $value['j_checkname']?></td>
				<td><?php echo $value['t_name']?></td>
				<td><?php echo $value['company']?></td>
				<td><img src="Public/uploads/<?php echo $value['imagepath']?>" height="35" width="50"></td>
				<td><?php echo '导演';?></td>
				<td><a href="?m=Team&a=seemore&tid=<?php echo $value['t_id']?>" class="mr5">[查看]</a><a href="?m=team&a=rebuilt&tid=<?php echo $value['t_id']?>">[修改]</a><a href="?m=team&a=del&pid=<?php echo $value['p_id']?>">[删除]</a></td>
			</tr>
			<?php }?>
			</tbody>
			</table>
...
<script src="http://localhost/phpwind/res/js/dev/pages/admin/common/common.js?v20130702"></script>
<script>
