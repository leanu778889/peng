	...
	<div class="table_list">
		<table width="100%" id="J_table_list" style="table-layout:fixed;">
			...
			<tr id="J_forum_tr_1">
				...
				<td class="tar"><?php echo $value['star']?></td>
				<td><img src="__APP__/Public/uploads/<?php echo $value['imagepath']?>" height="35" width="50"></td>
				<td><?php echo $value['t_name']?></td>
				<td><a href="#" target="_blank" class="mr5">[查看详细信息]</a><a href="#">[删除]</a></td>
			</tr>
			<?php }?>
			</tbody>
			</table>
